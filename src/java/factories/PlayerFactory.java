...
public abstract class PlayerFactory {
    ...
    public static Player createDefaultPlayer(GamePanel gamePanel, GameWorld gameWorld, Room myRoom) {
        ...
        tempPlayer.addComponent(AnimationComponent.class, new AnimationComponent(tempPlayer));
        PlayerFactory.loadDefaultPlayerAnimationFrames(tempPlayer);
        ...
        tempPlayer.addComponent(SoundComponent.class, new SoundComponent(gamePanel.getMainFrame()));
        loadDefaultPlayerSounds(tempPlayer);

        tempPlayer.moveTo(gameWorld.getCurrentRoom().getSpawnLocation());
    ...
    private static void loadDefaultPlayerSounds(Player player){
        SoundComponent soundComponent = player.getComponent(SoundComponent.class);
        soundComponent.addDamageSound(SoundFactory.getPlayerDamageSound());
    }
}
